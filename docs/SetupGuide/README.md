...
- iOS 14.0 or later — this is the deployment target required by the `reteno-react-native-sdk` podspec. The bundled native `Reteno` 2.7.3 pod itself supports iOS 12.0 or later
